      ...
      <div className="container">
        <div className="box card p-3 shadow border-0">
          ...
          <form className="mt-3" onSubmit={handleLogin}>
            ...
            <a href="/forget-password" className="border-effect cursor txt">
              Forgot Password?
            </a>
            ...
            <div className="d-flex align-items-center mt-3 mb-3">
              ...
              <Link to="/">
                <Button
                  className="cancel-btn btn-lg btn-big col ml-3"
                  variant="outlined"
                  onClick={() => {
                    setTimeout(() => {
            ...
            <Button
              className="loginWithGoogle mt-2 w-100"
              variant="outlined"
              onClick={() => {
                const btn =
            ...
            <div style={{ display: 'none' }} ref={googleBtnRef}>
              <GoogleLogin
                ...
                onError={() =>
                  enqueueSnackbar('Google login cancelled', {
                    variant: 'error',
                  })
                }
              />
